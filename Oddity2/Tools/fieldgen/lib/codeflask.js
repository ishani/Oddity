(function(window) {
    ...
    function initCodeFlask() {
        ...
        CodeFlask.run = function(selector, defaultLanguage, onchange) {
            ...
            if(target.length > 1) {
                ...
                for(i=0; i < target.length; i++) {
                    CodeFlask.generateDOM(target[i], onchange);
                }
            }else {
                CodeFlask.generateDOM(target[0], onchange);
            }

        }

        CodeFlask.generateDOM = function(target, onchange) {
            ...
            CodeFlask.handleInput(textarea, highlightCode, highlightPre, onchange);
        ...
        CodeFlask.handleInput = function(textarea, highlightCode, highlightPre, onchange) {

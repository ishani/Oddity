...
static fix16_t _fix16_sin_cache_index[4096] __IN_FLASH__ = { 0 };
static fix16_t _fix16_sin_cache_value[4096] __IN_FLASH__ = { 0 };
#endif

#ifndef FIXMATH_NO_CACHE
static fix16_t _fix16_atan_cache_index[2][4096] __IN_FLASH__ = { { 0 }, { 0 } };
static fix16_t _fix16_atan_cache_value[4096] __IN_FLASH__ = { 0 };
#endif
